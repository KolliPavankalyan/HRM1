Feature: OrangeHRM
  ...
  Scenario: Login with valid Username and password credentials
    Given I navigated to Login page
    When I enter valid email address and valid password as into the fields
  ...
  Scenario: Login without entering any credentials
    ...
    And I click on Login button
    Then I should get a proper warning message without enter any details
